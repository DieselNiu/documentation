...
<AccordionGroup>
  <Accordion title="grok-imagine/text-to-image-lite">
    **Cheapest tier**
    ...
    - `n` range: 1-4
    - Output dimensions decided by Grok's chat engine (typically ~784×1168 portrait, varies per generation). Does **not** accept `ratio` / `resolution`.
...
<ParamField body="input" type="object" required>
  <Expandable title="properties" defaultOpen>
    ...
    <ParamField body="ratio" type="string">
      ...
      **Not supported by `text-to-image-lite`** — lite output dimensions are decided by Grok (typically portrait, varies per generation).
    </ParamField>
