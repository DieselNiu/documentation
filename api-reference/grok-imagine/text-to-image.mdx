...
<AccordionGroup>
  <Accordion title="grok-imagine/text-to-image-lite">
    **Cheapest tier**
    ...
    - `n` range: 1-4
    - Output is a portrait image; exact dimensions are decided by Grok and may vary per generation. Does **not** accept `ratio` / `resolution`.
...
<ParamField body="input" type="object" required>
  <Expandable title="properties" defaultOpen>
    ...
    <ParamField body="ratio" type="string">
      ...
      **Not supported by `text-to-image-lite`** — lite output is a portrait image with dimensions decided by Grok.
    </ParamField>
