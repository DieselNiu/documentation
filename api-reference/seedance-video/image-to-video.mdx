...
<ParamField body="input" type="object" required>
  <Expandable title="properties" defaultOpen>
    ...
    <ParamField body="mediaUrls" type="string[]">
      List of **1 to 12** reference material URLs, including image URLs, video URLs, and audio URLs. You can upload **up to 9 images**. The total uploaded video duration must be **15 seconds or less**. Material type is auto-detected by file extension. The number and type of materials determine the generation mode (see below).
    </ParamField>
